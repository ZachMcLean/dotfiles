...
# from libqtile.utils import qtile_path

# @hook.subscribe.startup_once
# def startup_once():
#     subprocess.run('/home/zach/.config/qtile/autostart_once.sh')
    ...
    keys.extend(
        [
            ...
            Key(
                [mod, "shift"],
                i.name,
                # I changed switch_group to false so whn i send window to group, it does NOT focus that group
...
def get_widgets(primary=False):
    widgets = [
       ...
       widget.GroupBox(
            ...
            highlight_color = [catppuccin["red"], catppuccin["red"]],
